...
export const createCube = (name = 'myCube'): THREE.Mesh => {
...
export const createSphere = (): THREE.Mesh => {
...
export const createSphereGroup = (
...
interface SphereRingResult {
  sphereGroup: THREE.Group;
  spheres: SphereWithAngle[];
}

export function createSphereRing(
  sphereCount: number,
